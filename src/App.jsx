...
export default function BorderlessLanding() {
  ...
  async function handleSubmit(e) {
    ...
    const source = formData.get("source") || "borderless-blueprint-landing";

    // 🔹 Open dossier instantly (UX stays smooth even if network/Webhook has issues)
    const win = window.open(PREVIEW_URL, "_blank", "noopener,noreferrer");
    if (!win) window.location.href = PREVIEW_URL;

    // 🔹 Fire-and-forget submission to Make webhook
    try {
      ...
      console.error(err);
      setErrorMsg(
        "We couldn’t confirm the submission, but your dossier opened."
      );
      setStatus("error");
    }
  }
    ...
    <div className="min-h-screen bg-black text-slate-100 selection:bg-amber-400/30">
      ...
      <section id="hero" className="text-center py-24 px-6 max-w-4xl mx-auto">
        ...
        <p className="text-slate-300 text-lg mb-8">
          <strong>Borderless Blueprint</strong> is a 63-page playbook for
          digital-first founders to structure, operate, and scale
          internationally using legitimate strategies—offshore entities,
          compliant banking, and documentation that passes scrutiny. No hype.
          No crypto wizardry. Just systems that work.
        </p>
        <a
          href="#signup"
          className="inline-block px-8 py-3 rounded-2xl bg-gradient-to-b from-amber-400 to-amber-600 text-black font-medium hover:opacity-90 transition"
        >
          Receive the Dossier
        </a>
      </section>
      ...
      <section
        id="problem"
        className="border-t border-white/10 py-20 px-6 max-w-4xl mx-auto text-center"
      >
        <h2 className="text-2xl font-semibold text-amber-400 mb-6">
          Why you need this
        </h2>
        <p className="text-slate-300 leading-relaxed max-w-2xl mx-auto">
          If your income crosses borders but your structure doesn’t, you’re
          already at risk. Founders lose accounts, overpay taxes, and stall
          growth because the backend is a mess—no compliance, no documentation,
          no separation.
        </p>
      ...
      <section
        id="solution"
        className="border-t border-white/10 py-20 px-6 max-w-5xl mx-auto text-center"
      >
        <h2 className="text-2xl font-semibold text-amber-400 mb-6">
          The practical playbook for operating without borders.
        </h2>
        <p className="text-slate-300 leading-relaxed max-w-3xl mx-auto">
          <strong>Borderless Blueprint</strong> shows you how to build a
          compliant, tax-efficient international structure that banks respect
          and regulators understand. No loopholes. No theatrics. Implementation
          over ideology.
        </p>
        <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-6 text-left text-sm text-slate-300">
          <div className="p-6 bg-zinc-900/60 rounded-2xl ring-1 ring-white/10">
            <h3 className="text-amber-300 font-semibold mb-2">
              01 — Entity & Jurisdiction
            </h3>
            <p>
              How to pick where to incorporate and what to avoid—without
              blacklist risk or high-maintenance setups.
            </p>
          </div>
          <div className="p-6 bg-zinc-900/60 rounded-2xl ring-1 ring-white/10">
            <h3 className="text-amber-300 font-semibold mb-2">
            ...
            <p>
              Accounts that don&apos;t freeze. Multi-currency flows that reduce
              friction and FX loss.
            </p>
          </div>
          <div className="p-6 bg-zinc-900/60 rounded-2xl ring-1 ring-white/10">
            <h3 className="text-amber-300 font-semibold mb-2">
              03 — Compliance & Records
            </h3>
            <p>
              The minimum viable documentation that keeps audits calm and
              operations clean.
            </p>
          </div>
        </div>
      ...
      <section
        id="preview"
        className="border-t border-white/10 py-20 px-6 text-center"
      >
        <h2 className="text-2xl font-semibold text-amber-400 mb-6">
          Inside the Dossier
        </h2>
        <p className="text-slate-300 max-w-2xl mx-auto mb-8">
          A concise preview from the full 63-page playbook—frameworks,
          checklists, and templates you can implement this week.
        </p>
      ...
      >
        <h2 className="text-2xl font-semibold text-amber-400 mb-6">
          When you’re ready for the full playbook
        </h2>
        <p className="text-slate-300 max-w-2xl mx-auto mb-8">
          The complete <strong>Borderless Blueprint</strong> gives you the
          structure used by serious founders—setup walkthroughs, templates,
          banking stack, and a documentation framework that scales.
        </p>
        <a
      ...
      <section id="signup" className="border-t border-white/10">
        <div className="max-w-6xl mx-auto px-6 py-16 text-center">
          ...
          <p className="mt-3 text-slate-300 max-w-2xl mx-auto">
            Enter your details to access the Borderless Blueprint dossier
            instantly. You’ll also join our private founder list.
          </p>

          {status !== "success" && (
            <form
              onSubmit={handleSubmit}
              className="mt-8 grid sm:grid-cols-2 gap-4 max-w-xl mx-auto"
            >
              <input
                id="name"
                name="name"
              ...
              <div className="sm:col-span-2 flex items-start gap-3">
                ...
                >
                  I agree to receive the dossier and occasional updates.
                  Unsubscribe anytime.
                </label>
              </div>
              <input
                type="hidden"
                name="source"
                value="borderless-blueprint-landing"
              />
              <button
                type="submit"
          ...
          {status === "success" && (
            <div className="mt-8 rounded-3xl ring-1 ring-white/10 bg-zinc-900 p-6 max-w-xl mx-auto">
              ...
              <p className="mt-3 text-sm text-slate-300">
                Your dossier opened in a new tab. You can also open it again
                below.
              </p>
              <a
                href={PREVIEW_URL}
      ...
      <footer className="border-t border-white/10">
        <div className="max-w-6xl mx-auto px-6 py-10 text-xs text-slate-400 text-center">
          <p>
            © {new Date().getFullYear()} Torvaire Capital / Borderless
            Blueprint. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
